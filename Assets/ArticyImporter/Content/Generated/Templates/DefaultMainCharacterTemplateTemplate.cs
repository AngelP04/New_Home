...
namespace Articy.New_Home.Templates
{
    ...
    public class DefaultMainCharacterTemplateTemplate : IArticyBaseObject, IPropertyProvider
    {
        ...
        public Articy.New_Home.Features.DefaultExtendedCharacterFeatureFeature DefaultExtendedCharacterFeature
        {
            get
            {
        ...
        {
            Articy.New_Home.Templates.DefaultMainCharacterTemplateTemplate newClone = ((Articy.New_Home.Templates.DefaultMainCharacterTemplateTemplate)(aClone));
            if ((DefaultExtendedCharacterFeature != null))
            {
                newClone.DefaultExtendedCharacterFeature = ((Articy.New_Home.Features.DefaultExtendedCharacterFeatureFeature)(DefaultExtendedCharacterFeature.CloneObject(newClone, aFirstClassParent)));
            }
        ...
        {
            Articy.New_Home.Templates.DefaultMainCharacterTemplateTemplate clone = new Articy.New_Home.Templates.DefaultMainCharacterTemplateTemplate();
