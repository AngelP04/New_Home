...
namespace Articy.New_Home.Features
{
    ...
    public class DefaultBasicCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.New_Home.Features.DefaultBasicCharacterFeatureFeature newClone = ((Articy.New_Home.Features.DefaultBasicCharacterFeatureFeature)(aClone));
            newClone.Age = Age;
            if ((mSpecies != null))
            {
        ...
        {
            Articy.New_Home.Features.DefaultBasicCharacterFeatureFeature clone = new Articy.New_Home.Features.DefaultBasicCharacterFeatureFeature();
