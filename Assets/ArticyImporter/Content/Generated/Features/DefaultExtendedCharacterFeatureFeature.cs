...
namespace Articy.New_Home.Features
{
    ...
    public class DefaultExtendedCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.New_Home.Features.DefaultExtendedCharacterFeatureFeature newClone = ((Articy.New_Home.Features.DefaultExtendedCharacterFeatureFeature)(aClone));
            if ((mMotivation != null))
            {
        ...
        {
            Articy.New_Home.Features.DefaultExtendedCharacterFeatureFeature clone = new Articy.New_Home.Features.DefaultExtendedCharacterFeatureFeature();
